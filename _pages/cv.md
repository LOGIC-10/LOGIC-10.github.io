...
**Advisor: Professor [Zhiyuan Liu](http://nlp.csai.tsinghua.edu.cn/~lzy/) | Tsinghua University | THUNLP | China**
  ...
  - Demonstrated strong performance across all metric, indicating that the documentation generated by RepoAgent surpassed human-generated documentation, achieving tasks that traditional methods could not. The paper is to be
  published on arxiv and submitted to EMNLP 2024, with the [code](https://github.com/OpenBMB/RepoAgent) and [demonstration](https://www.youtube.com/watch?v=YPPJBVOP71M) open-sourced.

### Learning to Proactively Predict Implicit Human Intents
ARR stage for EMNLP, about to release...
